...
public class voiceOption extends AppCompatActivity {
    ...
    private double border_Left=(double)1/640*212;
    private double border_Lower=(double)1/640*212;
    private double border_Right=(double)1/640*426;
    private double border_Top=(double)1/640*426;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        random.setText(Double.toString(randx_median)+"\n" +Double.toString(randy_median)+"\n" +Double.toString(rand_height)+"\n" +Double.toString(rand_width));
    ...
    private String inputLocation(double x_median, double y_median, double height, double width)
    {
        ...
        if(x_median< border_Left) { //x 중앙값이 왼쪽 경계에 있을때
            ...
            System.out.println("label value error");
